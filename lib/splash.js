    ...
    dom(
      ...
      active
        ? [
            ...
            dom('br'),
            dom('b.active', active),
            ' utilisateurs active de ',
            dom('b.total', total),
            ' enregistrés.'
          ]
        : [
            dom('b.total', total),
            ' users are registered so far.',
            dom('br'),
            dom('b.total', total),
            " utilisateurs sont enregistrés jusqu'à présent."
          ]
    ),
    dom(
      'form id=invite',
      ...
      dom('button.loading', 'Get my Invite / Invitez-moi')
    ),
    dom(
      'p.signin',
      'or go to ',
      dom(`a href=https://${org}.slack.com target=_top`, `${org}.slack.com`),
      ' now.',
      dom('br'),
      'ou visitez ',
      dom(`a href=https://${org}.slack.com target=_top`, `${org}.slack.com`),
